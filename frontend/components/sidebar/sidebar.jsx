        ...
        <li className='sidebar-btn'>
          <Link to='/home/notebooks/all/notes/all'>
            <img className='side-notes'
                 ...
                 data-toggle='tooltip' title='NOTES' data-placement='right'/>
          </Link>
        </li>
        ...
        <li className='sidebar-btn'>
          <Link to='/home/notebooks/all'>
            <img className='side-notebooks'
                 ...
                 data-toggle='tooltip' title='NOTEBOOKS' data-placement='right'/>
          </Link>
        </li>
        ...
        <li className='sidebar-btn'>
          <Link to='/home/tags/all'>
            <img className='side-tags'
                 ...
                 data-toggle='tooltip' title='TAGS' data-placement='right'/>
          </Link>
        </li>
      </ul>
